...
export default function PlayerPoints({
    ...
    const { currWeekPoints, prevWeekPoints, totalPoints } = seasonStats
    ...
    return (
        <Div h={126} mt={32} ml={24} mr={24} br={12} bs={SHADOW_WHITE_SMOKE} className={'flex items-center'}>
            <Div w={'33.3%'} className={'flex flex-col items-center'}>
                <Text text={prevWeekPoints} fst={'italic'} fw={800} fs={28} lh={32} color={colors.black_rock}/>
            ...
            <Div w={'33.3%'} className={'flex items-center justify-center'}>
                ...
                <Div className={'flex flex-col items-center'} ml={44} mr={45}>
                    <Text text={currWeekPoints} fst={'italic'} fw={800} fs={28} lh={32} pr={5} className={'text-froly-cerise_red'}/>
            ...
            <Div w={'33.3%'} className={'flex flex-col items-center'}>
                <Text text={totalPoints} fst={'italic'} fw={800} fs={28} lh={32} color={colors.black_rock}/>
