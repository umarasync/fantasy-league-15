...
export default function CreateLeagueModal({ show, onClose, onConfirm }) {
  const loadingFantasyLeagueCreation = useSelector(
    ({ fantasyLeague }) => fantasyLeague.loadingFantasyLeagueCreation
  );
      ...
      >
        <Div w={482} br={12} bg={colors.white} p={24}>
          ...
          <Button
            ...
            disabled={loadingFantasyLeagueCreation}
            onClick={() =>
              !loadingFantasyLeagueCreation && onConfirm(leagueName)
            }
            mt={32}
          />
        </Div>
