...
export default function LeagueCard({
  ...
  const image = "private_league.png";
  const points = 70;
  ...
  return (
    <Div
      ...
      pb={pb}
      pt={pt}
      onClick={() => (onClick ? onClick(league) : false)}
    >
      <Div className={"flex"}>
        ...
        <Div ml={12}>
          ...
          />
          <Text
            text={`${nFormatterWOSign(members)}
                            ${
                              members < limitToShowPlusSign &&
                              members > minLimitToShowPlusSign
                                ? "+"
                                : ""
                            } 
