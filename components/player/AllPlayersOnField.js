...
// Constants
import { ZERO, ONE, TWO, THREE, FOUR } from "constants/arrayIndexes";
import {
  POSITION_DEF,
  POSITION_FWD,
  POSITION_GK,
    ...
    <div style={{ paddingTop: R(27) }}>
      ...
      <Div style={STYLES.container}>
        <PlayerOnPitch
          ...
          onDeselectPlayer={() => {
            onDeselectPlayer(POSITION_GK, ZERO);
          }}
        />
        <PlayerOnPitch
          player={p2}
      ...
      <Div style={STYLES.container}>
        <PlayerOnPitch
          ...
          onDeselectPlayer={() => {
            onDeselectPlayer(POSITION_DEF, ZERO);
          }}
        />
        <PlayerOnPitch
          player={p4}
          ...
          onDeselectPlayer={() => {
            onDeselectPlayer(POSITION_DEF, ONE);
          }}
        />
        <PlayerOnPitch
          player={p5}
          ...
          onDeselectPlayer={() => {
            onDeselectPlayer(POSITION_DEF, TWO);
          }}
        />
      </Div>
      {/*3*/}
      <Div style={STYLES.container}>
        <PlayerOnPitch
          ...
          onDeselectPlayer={() => {
            onDeselectPlayer(POSITION_DEF, THREE);
          }}
        />
        <PlayerOnPitch
          player={p7}
          ...
          onDeselectPlayer={() => {
            onDeselectPlayer(POSITION_DEF, FOUR);
          }}
        />
      </Div>
      {/*4*/}
      <Div style={STYLES.container}>
        <PlayerOnPitch
          ...
          onDeselectPlayer={() => {
            onDeselectPlayer(POSITION_MID, ZERO);
          }}
        />
        <PlayerOnPitch
          player={p9}
          ...
          onDeselectPlayer={() => {
            onDeselectPlayer(POSITION_MID, ONE);
          }}
        />
        <PlayerOnPitch
          player={p10}
          ...
          onDeselectPlayer={() => {
            onDeselectPlayer(POSITION_MID, TWO);
          }}
        />
      </Div>
      {/*5*/}
      <Div style={STYLES.container}>
        <PlayerOnPitch
          ...
          onDeselectPlayer={() => {
            onDeselectPlayer(POSITION_MID, THREE);
          }}
        />
        <PlayerOnPitch
          player={p12}
          ...
          onDeselectPlayer={() => {
            onDeselectPlayer(POSITION_MID, FOUR);
          }}
        />
      </Div>
      {/*6*/}
      <Div style={STYLES.container} mt={1}>
        ...
        <PlayerOnPitch
          ...
          onDeselectPlayer={() => {
            onDeselectPlayer(POSITION_FWD, TWO);
          }}
        />
      </Div>
    </div>
